...
const MODELS = [
  { id: 'gemini-2.5-flash-lite', label: 'Gemini 2.5 Flash Lite (fast, most free quota)' },
  { id: 'gemini-2.5-flash', label: 'Gemini 2.5 Flash (recommended)' },
  { id: 'gemini-2.5-pro', label: 'Gemini 2.5 Pro (deep reasoning, billing required)' },
  { id: 'gemini-2.0-flash', label: 'Gemini 2.0 Flash (retired — may not work)' },
  { id: 'gemini-2.0-flash-lite', label: 'Gemini 2.0 Flash Lite (retired — may not work)' },
  { id: 'gemini-1.5-pro', label: 'Gemini 1.5 Pro (deprecated — may not work)' },
];

export default function Settings() {
  const [keys, setLocalKeys] = useState({ gemini: '', openai: '', tavily: '' });
  const [prefs, setLocalPrefs] = useState({ voiceMode: 'interviewer', answerLength: 'auto', model: 'gemini-2.5-flash-lite' });
