...
import { FileText, Timer, Code2, BookOpenText, Settings as Cog, Sparkles, EyeOff, Rocket, TrendingUp, Building2 } from 'lucide-react';
  ...
  return (
    <div className="max-w-6xl mx-auto px-8 py-10" data-testid="dashboard-page">
      ...
      <div className="flex items-baseline gap-3 mb-4">
        ...
        <span className="text-[11px] text-white/30 font-mono-ui">06</span>
      </div>
